...
class HomeComponent extends Component
{
    ...
    public function render()
    {
        ...
        $products = Product::whereDate('created_at', now()->today())->where('status',1)->take(10)->get();
        // $products = Product::take(8)->get();
        $exchnageproducts = Product::where('is_exchange',1)->where('status',1)->latest()->get()->take(6);
        $sellproducts = Product::where('is_sell',1)->where('status',1)->latest()->get()->take(10);
