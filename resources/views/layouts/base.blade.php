        ...
        <a class="list-title" href="help.html"> <i class="lar la-question-circle icon"></i> Help</a>
                                    ...
                                    <li class="list">
                                        ...
                                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                         ...
                                         <i  class="las la-sign-out-alt icon"></i>    {{ __('Logout') }}
                                        </a>
                        ...
                        @else
                        <li class="single">
                            <!-- <a class="popup-btn-login" title="Register or Login" >Login</a> -->

                            <div class="btn-wrapper">
                                <a href="#" class="cmn-btn1 popup-btn-login">
                                <i class="las la-sign-in-alt icon"></i> <span class="text">Login</span>
                                </a>
                            </div>
                        </li>
                        <!-- <li class="menu-item">
