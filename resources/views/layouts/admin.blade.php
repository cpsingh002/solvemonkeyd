                            ...
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: (+123) 456 789" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Hotline: 454354355</a>
                                </li>
                            </ul>
                        </div>
                        <div class="topbar-menu right-menu">
                            <ul>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    <a title="My Account" href="{{route('admin.dashboard')}}">My
                ...
                <div class="container">
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-logo-top left-section" style="background: brown">
                            <a href="/" class="link-to-home"><img src="{{asset('assets/images/logo-default.jpg')}}"
                                    alt="mercado"></a>
                        </div>
