...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('admin/css/color-01.css')}}">
...
<body class="home-page home-01 ">
			...
			<div class="row">
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							...
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: 454354355</a>
								</li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section" style="background: brown">
							<a href="/" class="link-to-home"><img src="{{asset('assets/images/logo-default.jpg')}}" alt="mercado"></a>
						</div>
	...
	<script src="{{asset('admin/js/jquery-1.12.4.minb8ff.js?ver=1.12.4')}}"></script>
	<script src="{{asset('admin/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4')}}"></script>
	<script src="{{asset('admin/js/bootstrap.min.js')}}"></script>
	<script src="{{asset('admin/js/jquery.flexslider.js')}}"></script>
	<script src="{{asset('admin/js/chosen.jquery.min.js')}}"></script>
	<script src="{{asset('admin/js/owl.carousel.min.js')}}"></script>
	<script src="{{asset('admin/js/jquery.countdown.min.js')}}"></script>
