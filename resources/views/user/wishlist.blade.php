...
<a href="../login.html" class="account-btn"><i class="las la-sign-out-alt icon"></i> Logout</a>
</div>
</div>
</div>
...
<a href="{{'wishlist'}}" class="cmn-btn-outline5"><i class="las la-heart icon"></i>Favourite</a>
</div>
</div>
</div>
...
<div class="adsCaption">
<h5><a href="{{'product-details'}}" class="adsTittle">Luxury couple apartment</a></h5>
<p class="adsPera">Dallas, Texas · <strong class="subCap">24hrs ago</strong></p>
