                                            ...
                                            <div class="row">
                                                <div class="sa-example__body py-0">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="file" class="form-control" id="formFile-21" wire:model="newthumbimage">
                                                            @if($newthumbimage)
                                                                <img src="{{$newfeatimage->temporaryUrl()}}" width="120" />
                                                            @else
                                                                <img src="{{asset('admin/product/thumb/')}}/{{$thumbimage}}" width="120" /> 
                                                            @endif
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="file" class="form-control" id="formFile-2" wire:model="newfeatimage">
                                                            @if($newfeatimage)
                                                                <img src="{{$newfeatimage->temporaryUrl()}}" width="120" />
                                                            @else
                                                                <img src="{{asset('admin/product/feat/')}}/{{$featimage}}" width="120" /> 
                                                            @endif
                                                            @error('newfeatimage') <p class="text-danger">{{$message}}</p> @enderror
                                                    ...
                                                    <div class="mb-4">
                                                            ...
                                                            <input type="file" class="form-control" id="formFile-3" wire:model="newimages" multiple>
                                                            @if($newimages)
                                                            ...
                                                            @else
                                                                ...
                                                                @foreach($images as $image)
                                                                    @if($image)
                                                                        <img src="{{asset('admin/product/image/')}}/{{$image}}" width="120"/>
                                                                    @endif
                                                                @endforeach
                                                            @endif
