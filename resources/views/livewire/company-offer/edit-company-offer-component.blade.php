            ...
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    <div class="col">
                        ...
                        <h1 class="h3 m-0">Edit Company Offer</h1>
                    </div>
                            ...
                            <div class="sa-entity-layout__main">
                                <div class="card">
                                    <div class="card-body p-5">
                                        ...
                                        @endif
                                        <form class="form-horizontal" wire:submit.prevent="updateOffer" enctype="multipart/form-data">
                                            <div class="mb-5">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="input-group input-group--sa-slug">
                                                    <input type="file" placeholder="Category Logo" class="input-file"   wire:model="newcompany_logo" />
                                                   
                                                    @if($newcompany_logo)
                                                        <img src="{{$newcompany_logo->temporaryUrl()}}" width="120" />
                                                    @else
                                                        <img src="{{asset('admin/company/logo')}}/{{$company_logo}}" width="120" />
                                                    @endif
                                                    @error('newcompany_logo') <p class="text-danger">{{$message}}</p> @enderror
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="input-group input-group--sa-slug">
                                                    <input type="file" placeholder="Offer Template" class="input-file"   wire:model="newoffer_template" />
                                                    
                                                    @if($newoffer_template)
                                                        <img src="{{$newoffer_template->temporaryUrl()}}" width="120" />
                                                    @else
                                                        <img src="{{asset('admin/company/template')}}/{{$offer_template}}" width="120" />
                                                    @endif
                                                    @error('newoffer_template') <p class="text-danger">{{$message}}</p> @enderror
                                                </div>
