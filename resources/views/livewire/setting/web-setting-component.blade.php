                                     ...
                                     @if(Session::has('message'))
                                         ...
                                         <form class="form-horizontal" wire:submit.prevent="saveSettings">
                                             ...
                                             <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="file" placeholder="Category Icon" class="input-file input-md"  wire:model="newweb_logo"/>
                                                    @if($newweb_logo)
                                            ...
                                            <div class="form-group mb-4 col-md-6">
                                                <label class="col-md-4 control-label form-label">Facebook</label>
                                                <div >
                                            ...
                                            <div class="form-group mb-4 col-md-6">
                                                <label class="col-md-4 control-label form-label">Pinterest</label>
                                                <div >
                                            ...
                                            <div class="row">
                                            <div class="form-group mb-4 col-md-6">
                                                <label class="col-md-4 control-label form-label">Instagram</label>
                                                <div >
                                            ...
                                            <div class="form-group mb-4 col-md-6">
                                                <label class="col-md-4 control-label form-label">Youtube</label>
                                                <div >
