             ...
             <div class="py-5">
                 <div class="row g-4 align-items-center">
                     ...
                     <div class="col-auto d-flex">
                         <a href="{{route('admin.testattributes')}}" class="btn btn-primary">All Attributes</a>
                     </div>
                                         ...
                                         <form class="form-horizontal" enctype="multipart/form-data"
                                             ...
                                             <div class="mb-4">
                                                 <div>
                                                     ...
                                                     <select class="form-select" wire:model="category_id" wire:change="changeSubcategory" multiple>
                                             ...
                                             <div class="mb-4">
                                                 <div>
                                                     ...
                                                     <select class="form-select" wire:model="sub_category_id" wire:change="changeAttribute" multiple>
                                                         <option value="">None</option>
